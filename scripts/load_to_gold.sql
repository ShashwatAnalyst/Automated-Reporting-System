...
-- --------------------------------------------------------
-- Purpose:
-- This script creates the final reporting layer (gold layer)
-- using cleaned and integrated data from the silver layer.
-- All views are dropped and recreated in dependency order.
-- =========================================================
